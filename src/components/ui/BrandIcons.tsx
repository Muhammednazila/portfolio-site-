...
/**
 * Inline brand glyphs. lucide-react removed GitHub/LinkedIn marks in v1, so we
 * provide minimal SVGs here. They share lucide's API (accept className, size
 * via `size-*`, and inherit color via `fill="currentColor"`).
 */
